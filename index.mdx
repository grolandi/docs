...
<div className="mx-auto flex w-full max-w-5xl flex-col gap-14 px-4 py-12 lg:py-16">
  ...
  <div className="flex flex-col gap-4">
    ...
    <Card
      ...
      icon="users"
      iconType="light"
      href="/mica-devices/general-information"
      cta="3 articles"
    >
    ...
    <Card
      ...
      icon="credit-card"
      iconType="light"
      href="/mica-devices/connectivity"
      cta="3 articles"
    >
    ...
    <Card
      ...
      icon="code-xml"
      iconType="light"
      href="/mica-devices/installation"
      cta="3 articles"
    >
    ...
    <Card
      ...
      icon="folder-kanban"
      iconType="light"
      href="/mica-devices/local-communication"
      cta="2 articles"
    >
    ...
    <Card
      ...
      icon="wrench"
      iconType="light"
      href="/mica-devices/power-supply"
      cta="2 articles"
    >
    ...
    <Card
      ...
      icon="scale"
      iconType="light"
      href="/mica-devices/set-up-configuration"
      cta="7 articles"
    >
