...
<div className="mx-auto flex w-full max-w-5xl flex-col gap-14 px-4 py-12 lg:py-16">
  ...
  <div className="flex flex-col gap-4">
    ...
    <Columns cols={3}>
      <Card horizontal icon="cpu" iconType="light" title="MICA Devices" href="/mica-devices">
        Setup guides, connectivity, and technical information for MICA sensors
      </Card>

      <Card horizontal icon="monitor-dot" iconType="light" title="My inBiot Platform" href="/my-inbiot-platform">
        Account, workspace, dashboards, alerts, and certifications
      </Card>

      <Card horizontal icon="code" iconType="light" title="inBiot API" href="/inbiot-api">
        REST API reference, authentication, and data endpoints
      </Card>

      <Card horizontal icon="plug" iconType="light" title="BMS & Integrations" href="/bms-and-integrations">
        BMS connections, Modbus, BACnet, and third-party integrations
      </Card>
      ...
      <Card horizontal icon="circle-help" iconType="light" title="FAQ's" href="/faq">
